...
export const getAllTasks = async (encryptedCreatorId: string) => {
    try {
        ...
        console.log("Getting Quotes Error : ", error);
        return AES.encrypt(
...
export const registerTask = async (encryptedNewTaskString: string) => {
    try {
...
export const updateTask = async (encryptedTaskUpdateString: string) => {
    try {
...
export const deleteTask = async (encryptedTaskDeleteId: string) => {
    try {
